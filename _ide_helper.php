...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function setParams($limit = null, $page = null, $offset = null)
        {
                        /** @var \Leonidark\Paginator\PaginatorService $instance */
                        return $instance->setParams($limit, $page, $offset);
        }
                    /**
         * Пагинирует данные
         *
         * @param \Illuminate\Database\Eloquent\Builder|\Illuminate\Database\Query\Builder|\Illuminate\Support\Collection $data Строитель запроса (можно получить через getQuery()) или коллекция
         ...
         * @static 
         */ 
        public static function assignParams($list, $extra = [])
        {
                        /** @var \Leonidark\Paginator\PaginatorService $instance */
                        return $instance->assignParams($list, $extra);
        }
                    /**
...
namespace  { 
            ...
            class Paginator extends \Leonidark\Paginator\PaginatorFacade {}
